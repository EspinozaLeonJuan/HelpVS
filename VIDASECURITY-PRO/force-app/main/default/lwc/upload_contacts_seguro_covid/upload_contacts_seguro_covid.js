...
import uploadFile from '@salesforce/apex/CLS_LWC_Gestion_Seguro_Covid.uploadFileContacts';
import saveFile from '@salesforce/apex/CLS_LWC_Gestion_Seguro_Covid.saveFileContacts';

import {ShowToastEvent} from 'lightning/platformShowToastEvent';

const columns = [
    { label: 'RUT Empresa', fieldName: 'RutEmpresa' , type: 'text' },
    { label: 'RUT Contacto', fieldName: 'RutContacto' , type: 'text' },
    { label: 'Nombre Contacto', fieldName: 'NombreContacto', type: 'text' },
    { label: 'Apellido Contacto', fieldName: 'ApellidoContacto', type: 'text' },
    { label: 'Tipo Contacto', fieldName: 'TipoContacto' , type: 'text' },
    { label: 'Correo electrónico', fieldName: 'EmailContacto' , type: 'text' },
    { label: 'Rut Empresa Corredora', fieldName: 'RutEmpresaCorredora' , type: 'text' }
 ];



export default class Upload_contacts_seguro_covid extends LightningElement {
...
console.log('handleSave');
  ...
  previousHandler() {
   ...
   saveToFile() {
    ...
    saveFile({ jsonData: JSON.stringify(this.fileContents)})
        .then(result => {
             window.console.log('result ====> ');
             window.console.log(result);
            this.isTrue = false;
            ...
            this.dispatchEvent(
                ...
                message: 'Los contactos han sido exitosamente actualizado!!!',
                    variant: 'success',
                }),
            );
            this.uploadCompleted = false;
