...
import PoseeHijos_EnProceso from '@salesforce/apex/CLS_CS_Gestion_CasoAtencion.PoseeHijos_EnProceso';
...
export default class Gestion_caso_atencion extends LightningElement {
    ...
    saveMethod_close() {
        ...
        PoseeHijos_EnProceso({Id : this.recordId})
        .then(r => {
            if(r == false){
                ...
                const evt = new ShowToastEvent({
                    title: 'Cierre de Caso Atención',
                    message: 'No es posible cerrar el Caso de Atención ya que existen casos de requerimientos pendientes por resolver.',
                    variant: 'error',
                });
                this.dispatchEvent(evt);
            }
