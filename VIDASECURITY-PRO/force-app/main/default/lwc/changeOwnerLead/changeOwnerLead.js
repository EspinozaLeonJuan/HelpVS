...
import search from '@salesforce/apex/CLS_SearchController.search';
import getRecentlyCreatedRecord from '@salesforce/apex/CLS_SearchController.getRecentlyCreatedRecord';
const DELAY = 10;

import { NavigationMixin } from 'lightning/navigation';

export default class ChangeOwnerLead extends NavigationMixin(LightningElement) {
  ...
  @api fields        = ['Name'];
  @api displayFields = 'Name, Username';
  @api showLabel     = false;
  @api parentAPIName = 'OwnerId';
